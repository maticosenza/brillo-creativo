...
const BRANDS: { name: string; src: string; className?: string }[] = [
  { name: "Mercado Libre", src: mercadolibre, className: "h-[38px] max-w-[150px] translate-y-[3px]" },
  { name: "Fira Barcelona", src: fira },
  { name: "Monster Energy", src: monster },
  { name: "Sophos", src: sophos, className: "h-[72px] max-w-[180px] -translate-y-[4px]" },
  { name: "Heineken", src: heineken, className: "h-[40px] max-w-[150px] translate-y-[3px]" },
  { name: "Geopost", src: geopost },
  { name: "Datawise", src: datawise, className: "h-[44px] max-w-[160px]" },
  { name: "Atlassian", src: atlassian, className: "h-[60px] max-w-[200px]" },
  { name: "Coca-Cola", src: cocacola },
  { name: "Manga Barcelona", src: manga, className: "h-[38px] max-w-[150px] translate-y-[2px]" },
  { name: "Intelcia", src: intelcia, className: "h-[40px] max-w-[150px] translate-y-[2px]" },
