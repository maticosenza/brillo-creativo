...
export const BrandsSection = () => {
  ...
  return (
    <section className="bg-brand-red text-brand-white pt-[16px] pb-[24px] md:pt-[50px] md:pb-[100px]">
      ...
      {reduced ? (
        <ul className="mt-8 md:mt-20 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10 px-6 md:px-12">
          {BRANDS.map((b) => (
        ...
        <div
          className="mt-8 md:mt-20 marquee-mask group"
          style={{
            WebkitMaskImage:
