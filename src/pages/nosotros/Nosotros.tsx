  ...
  return (
    <>
      ...
      <section className="bg-brand-red text-brand-white section-y px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-start max-w-7xl mx-auto">
          <div>
            ...
            <div className="mt-8 space-y-5 text-base md:text-lg leading-[1.7] text-brand-white/90 text-left">
      ...
      <section className="mission-vision-values red-background">
        <div className="mission-vision-row">
          <div className="mvv-box">
            <h3>Misión</h3>
            <p className="text-left">Diseñar y ejecutar eventos de alto impacto, combinando estrategia, creatividad y excelencia operativa para generar experiencias memorables y resultados concretos para cada cliente.</p>
          </div>
          <div className="mvv-box">
            <h3>Visión</h3>
            <p className="text-left">Ser una productora referente en el sector deportivo y corporativo a nivel internacional, creando experiencias que eleven el estándar de ejecución, hospitality y producción en cada evento.</p>
          </div>
        </div>
      ...
      <GlobalReachSection
        ...
        subtitle="Radicados en Argentina pero con alcance y experiencia global. Somos tu partner estratégico en todo el mundo ya que hemos producido eventos en Estados Unidos, Latino America, Europa, África, Oceanía y Asia."
      />
